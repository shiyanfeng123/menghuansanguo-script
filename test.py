...
dm_ret = dm.FindPicEx(0, 0, x, y,
                      r"E:\project\python\serveAssets\images/auto/suohun_gray.bmp",
                      "", similarity, 0)
...
color_format = 'ffffff-00000|00ff00-000000|00fe0d-000000'  # 绿色字体
...
# find_str_result = dm.FindStrFastE(0, 0, x, y, "官渡颜良", color_format, sim)
