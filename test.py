...
dm_ret = dm.FindPicEx(0, 0, x, y,
                      r"E:\project\python\serveAssets\images/zdzd111.bmp",
                      "", similarity, 0)
...
# print('res111', res111)
# 249  342 391  352
# dm_ret = dm.FindColor(249, 340, 291, 352, "00ff00-000000", 0.6, 0)
print(dm_ret, 'dm_ret')
# x, y, r = dm_ret
# print(x, y, r)
# if r == 1:
...
# find_str_result = dm.FindStrFastE(0, 0, x, y, '乾坤洞三层', color_format, sim)
