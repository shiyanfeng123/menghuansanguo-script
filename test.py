...
dm_ret = dm.FindPicEx(0, 0, x, y, r"E:\project\python\serveAssets\images\zhengdian\zhuojun.bmp", "", 0.9, 0)
...
# example_function()
find_str_result = dm.FindStrFastE(0, 0, x, y, '涿郡野外', color_format, sim)
